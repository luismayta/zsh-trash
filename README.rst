...
1. Add ``antigen bundle luismayta/zsh-trash`` to your
...
1. Add ``antibody bundle luismayta/zsh-trash`` to your
   ``.zshrc`` where you're adding your other plugins.
2. Either open a new terminal to force zsh to load the new plugin, or
...
.. |Build Status| image:: https://travis-ci.org/luismayta/zsh-trash.svg
